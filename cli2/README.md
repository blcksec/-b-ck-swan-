...
Instructions are also available for installing and using the CLI [without a package manager](https://github.com/blcksec/stripe-cli/wiki/Installing-and-updating#without-a-package-manager).
